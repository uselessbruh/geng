  ...
  return (
    <div className="mri-container">
      <div className="mri-header">
        <h1>Brain MRI Generation</h1>
        <p>Generate synthetic brain MRI images using our advanced AI model</p>
      </div>
      ...
      <div className="mri-content">
        <div className="generation-section">
          ...
          <div className="info-section">
            <h3>About Generated MRIs</h3>
            <div className="info-grid">
              <div className="info-item">
                <span className="info-icon">🧠</span>
                <p>High-quality synthetic brain MRI scans</p>
              </div>
              <div className="info-item">
                <span className="info-icon">📊</span>
